...
export default function About() {
    ...
    return <div>
        <p className='text-center text-sm'>I build responsive, user-centered web apps with</p>
         <div
			ref={containerRef}
			style={{position: 'relative'}}
            className='variable-proximity text-center'
			>
				<VariableProximity
